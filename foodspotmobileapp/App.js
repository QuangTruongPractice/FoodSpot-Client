...
import ManageOrders from "./components/restaurant/ManageOrders"; // Mới
import ManageMenus from "./components/restaurant/ManageMenus"; // Mới
...
const RestaurantStackNavigator = () => (
  <RestaurantStack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <RestaurantStack.Screen name="AddFood" component={AddFood} options={{ title: "Thêm món ăn" }} />
